---
name: tt
description: "Time Tracker CLI: report / status / map / add / pause / resume / help. Runs in-plugin with no model turn; bare /time-tracker:tt prints help"
argument-hint: "[report|status|map|add|pause|resume|help] [args]"
---
...
in-plugin (report / status / map / add / pause / resume / help) with **no model turn** — the
